...
final class Help
{
    ...
    private const HELP_TEXT = [
        ...
        'CartTest Selection Options' => [
            ...
            ['arg' => '--test-suffix <suffixes>', 'desc' => 'Only search for test in files with specified suffix(es). Default: CartTest.php,.phpt'],
        ],

        'CartTest Execution Options' => [
